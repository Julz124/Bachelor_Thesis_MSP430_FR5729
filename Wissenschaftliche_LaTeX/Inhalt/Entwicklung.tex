...
\begin{figure}[h!]
	\centering
	\includegraphics[angle=270, width=1.0\textwidth]{../Bilder/observer_state_machine.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[angle=90, width=1.0\textwidth]{../Bilder/observer_activity_diagram_eusci_receive.png}
	\caption{Aktivit\"atsdiagramm -- Timer ISR}
