...
% Modernisierte Darstellung von C-Code mit listings ------------------------------
\usepackage{listings}
\usepackage{xcolor}

% Farbdefinitionen (dezenter, moderner Look)
\definecolor{bg}{RGB}{248,248,248}         % heller Hintergrund
\definecolor{codegray}{gray}{0.4}
\definecolor{commentgreen}{RGB}{63,127,95}
\definecolor{keywordblue}{RGB}{0,0,180}
\definecolor{stringred}{RGB}{163,21,21}
\definecolor{linenumbergray}{gray}{0.3}
...
\lstdefinestyle{modernC}{
	...
	captionpos=b,
	escapeinside={(*@}{@*)},
	morekeywords={NULL, uint8_t, int32_t, bool, true, false, inline, static, const, void}, % C-spezifische Ergänzungen
...
% Define a ragged-right column with automatic width (for tabularx)
\newcolumntype{L}{>{\RaggedRight\arraybackslash}X}

% For fixed width ragged right columns if needed
